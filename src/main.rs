...
fn main() {
    ...
    let part1 = day25::part1(&contents);
    let part2 = day25::part2(&contents);
...
mod test_solutions {
    ...
    fn test_day22() {
        ...
        let part1 = day22::part1(&contents);
        let part2 = day22::part2(&contents);

        assert_eq!(part1, 580810);
        assert_eq!(part2, 1265621119006734);
    }
}
